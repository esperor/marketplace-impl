            ...
            {query.data &&
              query.data
                ...
                .map(
                  (cartRecord) =>
                    cartRecord && (
                      <div className="flex flex-row gap-2" key={cartRecord?.id}>
                        <input
                          type="checkbox"
                        ...
                        />
                        <div className="rounded-md shadow-md border-none relative bg-slate-900 flex flex-1 h-fit flex-row gap-4">
                          <img
